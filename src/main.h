...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.03 * COIN;	// 3% PoS
...
static const uint256 hashGenesisBlock("0x0000030ab629a1508418e540daf163630042eb2707866e03e36947df31deb2cf");
static const uint256 hashGenesisBlockTestNet("0x0000030ab629a1508418e540daf163630042eb2707866e03e36947df31deb2cf");
...
public:
    ...
    {
        // GridPay: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // GridPay: get transaction coin age
...
public:
    ...
    // GridPay: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // GridPay: two types of block: proof-of-work or proof-of-stake
    ...
    // GridPay: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // GridPay: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // GridPay: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // GridPay: block index flags
    enum  
    {
